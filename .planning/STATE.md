...
**Current Focus:** Phase 04a — audit + validator (Stage 1 hard requirement)
...
- **Phase:** 04a (audit + validator) — Ready to plan. Stage 1 RFC §7 rollout requirement (must ship in the upstream commit PR).
- **Next after 04a:** Phase 5 (porting prep + upstream PR). Phase 4b (managed-status) is a Stage 2 follow-up; independent of Phase 5.
- **Plan:** Not started
